...
# Import and include working inference router
try:
    from routers import working_inference
    app.include_router(working_inference.router, prefix="/inference", tags=["inference"])
    logger.info("Working inference router loaded successfully")
except ImportError as e:
    logger.warning(f"Working inference router not available: {str(e)}")

# Import and include human feedback router
try:
    from routers import human_feedback
    app.include_router(human_feedback.router, prefix="/human-feedback", tags=["human-feedback"])
except ImportError:
    logger.warning("Human feedback router not available")

# Import and include automated training router
try:
    from routers import automated_training
    app.include_router(automated_training.router, prefix="/training-pipeline", tags=["training-pipeline"])
except ImportError:
    logger.warning("Automated training router not available")

# Note: Interactive annotation features have been integrated into existing /annotation router
...
# Note: Document processing endpoint moved to /inference/process-document
