...
param(
    ...
    [string]$UbuntuServer= "100.87.45.61",
    
    [Parameter(Mandatory=$false)]
    [string]$UbuntuUser = "neoworks",
...
function Send-Files {
    ...
    $tarCommand = "tar -czf xagent-deployment.tar.gz -C xagent-deployment-temp ."
    
    # Use PowerShell to create tar (Windows 10/11 has built-in tar)
