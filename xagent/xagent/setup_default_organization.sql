-- ============================================
-- SETUP DEFAULT ORGANIZATION & MIGRATE EXISTING DATA
-- ============================================
-- This script creates a default organization and migrates existing data
...
-- Show available admin users for reference
SELECT 
  'AVAILABLE_ADMIN_USERS' as info_type,
  id,
  email,
  role,
  created_at
...
WHERE raw_user_meta_data->>'role' = 'admin' 
   ...
   OR id IN ('06cb0260-217e-4eff-b80a-7844cce8b8e2', '59e33e0e-a6f4-4d24-a28f-db21947b7b12', 'e4498a0a-0ca8-4545-a221-886c1534ac25')
...
BEGIN
  ...
  -- Get user email (we'll use a default if not available)
  ...
  RAISE NOTICE 'Added user % as owner', v_user_id;
