-- ============================================
-- CREATE ORGANIZATION CLEAN (FROM SCRATCH)
-- ============================================
-- This script creates a fresh organization with proper error handling
...
BEGIN
  ...
  RAISE NOTICE 'Creating organization with slug: %', v_slug;
  ...
  -- Store the organization ID for verification
  PERFORM set_config('app.current_org_id', v_org_id::text, false);
