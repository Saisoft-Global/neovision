...
-- ============================================
-- This script completes the setup for your existing organization
...
DECLARE
  ...
  v_org_id uuid := '21fcd301-2aa4-4600-a8f8-7f95263f550b'::uuid; -- Your existing org ID
  v_agent_count integer;
  v_workflow_count integer;
BEGIN
  RAISE NOTICE 'Setting up existing organization: %', v_org_id;
...
WHERE o.id = '21fcd301-2aa4-4600-a8f8-7f95263f550b'::uuid
...
SELECT 
  ...
  created_by
FROM public.agents 
WHERE organization_id = '21fcd301-2aa4-4600-a8f8-7f95263f550b'::uuid
ORDER BY created_at;
...
BEGIN
  ...
  RAISE NOTICE '============================================';
  RAISE NOTICE 'Organization ID: 21fcd301-2aa4-4600-a8f8-7f95263f550b';
